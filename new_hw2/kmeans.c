...
int read_file(const char *string_of_points)
{
    const char input = string_of_points;
...
struct vector *kmeans(int K, int iter, int vec_cords, int epsilon, int len, struct vector *init_cent, struct vector *head_vec)
{
    double temp_dist;
    int a = 0;
    int b = 0;
